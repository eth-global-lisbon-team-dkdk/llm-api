class PromptContainer:
    def __init__(self, is_cloud_runtime=False):
        ...
        self.intro_prompt = """
            ...
            You do not send the user question or any other information. In the 'links' field, you can include links to resources that answer the user's question.
            Do not include multiple links from the same parent domain. Aim for 2-3 links and please ensure they are not 404.
            Examples:
